...
namespace UnityTimer.Examples
{
  public class TestTimerBehaviour : MonoBehaviour
  {
    ...
    {
      ResetState();
      Debug.Log(StartTimerButton);
      StartTimerButton.onClick.AddListener(StartTestTimer);
      CancelTimerButton.onClick.AddListener(CancelTestTimer);
      PauseTimerButton.onClick.AddListener(PauseTestTimer);
      ResumeTimerButton.onClick.AddListener(ResumeTestTimer);
    }
